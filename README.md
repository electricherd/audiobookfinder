...
* On Appveyor
    * [Audiobookfinder Build Linux 18.04](https://ci.appveyor.com/project/electricherd/audiobookfinder/) ![appveyor](https://ci.appveyor.com/api/projects/status/electricherd/audiobookfinder?branch=master&svg=true)
* On Travis
